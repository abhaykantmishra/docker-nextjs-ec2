...
const ShimmerButton = React.forwardRef((
  ...
  return (
    (<button
      ...
      className={cn(
        "group relative z-0 flex cursor-pointer items-center justify-center overflow-hidden whitespace-nowrap border border-white/10 px-4 py-[10px] text-white [background:var(--bg)]  dark:text-black",
      ...
      <div
        className={cn(
          "absolute -z-20 rounded-sm [background:var(--bg)] [inset:var(--cut)]"
        )} />
    </button>)
  );
});
